      ...
      <div className="mx-auto max-w-2xl py-4 sm:max-w-sm lg:max-w-2xl">
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6 ">
            <a
              href="https://api.whatsapp.com/send?phone=5581982053106&text=Ol%C3%A1!%20Encontrei%20seu%20contato%20atrav%C3%A9s%20de%20seu%20site%20e%20gostaria%20de%20conversar.%20"
              target="_blank"
